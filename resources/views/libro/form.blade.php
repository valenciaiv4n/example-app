<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="codigo" class="form-control @error('codigo') is-invalid @enderror" value="{{ old('codigo', $libro?->codigo) }}" id="codigo" placeholder="Codigo">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="editorial" class="form-control @error('editorial') is-invalid @enderror" value="{{ old('editorial', $libro?->editorial) }}" id="editorial" placeholder="Editorial">
