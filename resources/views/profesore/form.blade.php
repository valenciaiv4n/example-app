<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="matricula" class="form-control @error('matricula') is-invalid @enderror" value="{{ old('matricula', $profesore?->matricula) }}" id="matricula" placeholder="Matricula">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="domicilio" class="form-control @error('domicilio') is-invalid @enderror" value="{{ old('domicilio', $profesore?->domicilio) }}" id="domicilio" placeholder="Domicilio">
